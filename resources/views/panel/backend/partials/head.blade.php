...
<!-- Jquery Upload Theme Style -->
<link href="{{asset('plugins/fileupload/css/jquery.fileupload.css')}}" rel="stylesheet">

<!-- Editor Style -->
<link href="{{asset('css/vendor/editor.css')}}" rel="stylesheet">
