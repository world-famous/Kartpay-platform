...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<form role="form" action="{{ route('admins.update.gateway', ['id' => $gateway->id]) }}" method="post">
			{!! csrf_field() !!}
				
				<div class="form-group{{ $errors->has('gateway_name') ? ' has-error' : '' }}">
					<label for="gateway_name">Name</label>
					<input type="required" name="gateway_name" class="form-control" id="gateway_name" value="{{ $gateway->gateway_name }}" required>
