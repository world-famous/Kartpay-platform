        ...
        <div class="col-sm-12">
            ...
            <div class="row tile_count">
				<div class="col-md-3 col-sm-8 col-xs-12 tile_stats_count">
					<div class="count">{{ $transaction->id }}</div>
					<span class="count_top">Kartpay ID</span>
				</div>
				<div class="col-md-3 col-sm-8 col-xs-12 tile_stats_count">
					<div class="count">{{ $transaction->merchant_order_id }}</div>
					<span class="count_top">Order ID</span>
				</div>
                <div class="col-md-3 col-sm-8 col-xs-12 tile_stats_count">
					<div class="count"><i class="fa fa-inr" style="color:#ea6c44"></i> {{ $transaction->merchant_order_amount }}</div>
         ...
         <div class="col-md-12 col-sm-12 col-xs-12 x-panel">
			...
			<div class="row">
				<div class="col-md-12 col-sm-6 col-xs-2">
					...
					<div class="col-md-3">
						<b>{{ $transaction->merchant_order_id }}</b>
					</div>
					<div class="col-md-3">
						Currency
					</div>
