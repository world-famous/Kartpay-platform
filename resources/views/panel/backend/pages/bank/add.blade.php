...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<form role="form" action="{{ route('admins.store.bank') }}" method="post">
			{!! csrf_field() !!}

				<div class="form-group{{ $errors->has('bank_name') ? ' has-error' : '' }}">
					<label for="bank_name">Bank Name</label>
					<input type="required" name="bank_name" value="" class="form-control" id="bank_name" size="20" required>
				...
				<div class="form-group{{ $errors->has('bank_code') ? ' has-error' : '' }}">
					...
					<input type="required" name="bank_code" value="" class="form-control" id="bank_code" size="20">
