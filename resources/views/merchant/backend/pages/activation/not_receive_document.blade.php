	...
	<br>
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<p>Physical Document</p>
				<p></p>
				<p>You have missing the Following Documents in this Sequence.</p>
				<p></p>

				@if($document != null)
					@php
						$num = 1;
						if($document->proprietor_pan_card_is_received == 'NOT RECEIVED')
						{
						...
						if($document->gumasta_is_received == 'NOT RECEIVED')
						{
						...
						if($document->gst_in_is_received == 'NOT RECEIVED')
						{
						...
						if($document->importer_exporter_code_is_received == 'NOT RECEIVED')
						{
						...
						if($document->passport_is_received == 'NOT RECEIVED')
						{
						...
						if($document->aadhar_card_is_received == 'NOT RECEIVED')
						{
						...
						if($document->driving_license_is_received == 'NOT RECEIVED')
						{
						...
						if($document->voter_id_card_is_received == 'NOT RECEIVED')
						{
						...
						if($document->property_tax_receipt_is_received == 'NOT RECEIVED')
						{
						...
						if($document->bank_canceled_cheque_is_received == 'NOT RECEIVED')
						{
						...
						if($document->audited_balance_sheet_is_received == 'NOT RECEIVED')
						{
						...
						if($document->current_account_statement_is_received == 'NOT RECEIVED')
						{
						...
						if($document->income_tax_return_is_received == 'NOT RECEIVED')
						{
						...
						if($document->kartpay_merchant_agreement_is_received == 'NOT RECEIVED')
						{
					...
					@endphp
				@else
					<p>You have no missing documents yet.</p>
				@endif
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
				<input type="text" class="form-control" name="courier_tracking_id" id="courier_tracking_id" value="" required />
			</div>
		</div>
