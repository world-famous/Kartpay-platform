...
<div class="container">
    <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
			...
			<form class="form-horizontal" id="form_resend_link" role="form" method="POST" action="{{ route('resend_link_forgot') }}">
				{{ csrf_field() }}
				...
				<br><br>
				<button type="button" class="btn btn-block btn-default btn-lg btn-kartpay" id="btn_submit"  style="border-radius: 20px;background: orangered;font-size: 100%;width: 45%;margin-left: 25%;"onclick="submitForm();">Submit</button>
			</form>
		</div>
	</div>
</div>
