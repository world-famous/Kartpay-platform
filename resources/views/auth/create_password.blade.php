...
<div class="container">
	<div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
        <div class="col-lg-10 col-lg-offset-1 col-md-12" style="color: black;">
			...
			@if(isset($user))
				<p>
				<h2 class="text-center" style="color: black;">Create Password</h2>
				</p>
				...
				<form id="form_create_password" role="form" method="POST" action="{{ url('/verification/create_password') }}">
					{{ csrf_field() }}
					<div class="form-group{{ $errors->has('new_password') ? ' has-error' : '' }}">
						<input id="new_password" type="password" name="new_password" maxlength="16" placeholder="Enter new password" value="" required="required" autofocus="autofocus" class="form-control form-control-kartpay input-lg" style=" box-shadow: 0px 1px 10px 1px rgba(81, 64, 49, 0.19);color: black;font-size: 100%;height: 50%;border-radius: 10px;">
					...
					<div class="form-group{{ $errors->has('confirm_password') ? ' has-error' : '' }}">
						<input id="confirm_password" type="password" name="confirm_password" maxlength="16" placeholder="Enter confirm password" value="" required="required" autofocus="autofocus" class="form-control form-control-kartpay input-lg" style="font-size: 100%;height: 50%;box-shadow: 0px 1px 10px 1px rgba(81, 64, 49, 0.19);color: black;border-radius: 10px;">
					...
					<br><br>
					<button type="submit" id="btn_submit" class="btn btn-block btn-default btn-lg btn-kartpay" style="height: 50%;border-radius: 20px;background: orangered;font-size: 100%;width: 62%;margin-left: 15%;margin-top: -15%;">
						Submit
					</button>
				</form>
			@else
				Verification link invalid, Please use the forgot password procedure.
			@endif
        </div>
    </div>
</div>
